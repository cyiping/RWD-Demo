...
<body onload="getMessages();">
	...
	<script>
		function postMessage() {
			...
			xmlhttp.open("POST", "${pageContext.request.contextPath}/ShoutServlet2?t=" + new Date(), false);
		...
		function getMessages() {
			if (!messagesWaiting) {
				...
				xmlhttp.open("GET", "${pageContext.request.contextPath}/ShoutServlet2?t=" + new Date(), true);
				xmlhttp.send();
			}
		}
